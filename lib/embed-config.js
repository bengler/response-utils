...
var EmbedConfig = (function(){
  ...
  EmbedConfig.normalizeHashTag = function(hashTag) {
  ...
  EmbedConfig.prototype.parse = function() {
    ...
    var title = config.title, kind = config.kind, previewCount = config.previewCount, hashTag = config.hashTag, publication = config.publication, articleTitle = config.articleTitle, articleUrl = config.articleUrl, articleId = config.articleId, enableImageSharing = config.enableImageSharing, facebookAppId = config.facebookAppId, likesKind = config.likesKind, likesLabelDefault = config.likesLabelDefault, likesLabelGiven = config.likesLabelGiven;
